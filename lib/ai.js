/**
 * LIB/AI.JS - Adaptateur OpenAI (Optimisé gpt-5-nano)
 */
...
// gpt-5-nano est le plus économique et très performant.
 ...
 * @param {boolean} jsonMode - Si true, force le format JSON (très fiable sur gpt-5-nano)
 */
